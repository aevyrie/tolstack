...
TolStack is a cross platform tolerance analysis application made for building and analyzing one-dimensional tolerance models. Works on Windows, MacOS, and Linux. **Breaking changes in master**
